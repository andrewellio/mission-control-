...
A process may be pulled from the stored logs to be further reviewed if it fails to perform at its expected level, as defined in section 3.4. The process that this review will take, will be:
