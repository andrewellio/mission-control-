...
In order to achieve the usability requirement, the mission control software needs to run on any operating system, also should no installation and internet connection required. The software should have a graphic interface to display data, also should have buttons to make the user interaction with software easily. 
