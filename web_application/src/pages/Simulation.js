...
function Simulation() {
  ...
  const data = [
    {//examples by id, '' for strings or num
      ...
      launchTemp: launchTempValue,
      launchTempStdDev: launchTempStdDev,
      altitude: launchAltitudeValue,
      pressure: launchPressureValue,
      pressureStdDev: launchPressureStdDev,
      turbulenceIntensity: turbulenceIntensityValue,
      motorPerformanceMean: motorPerformanceMeanValue,
      motorPerformanceMeanStdDev: motorPerformanceMeanStdDev,
      numberOfSimulations: numberOfSimulationsValue,
